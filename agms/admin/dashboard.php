...
<body>
  ...
  <section id="container" class="" style="position:absolute">
 ...
 <?php include_once('includes/header.php');?>
    ...
    <section id="main-content">
      <section class="wrapper">
        ...
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header" style="color:#e38024"><i class="fa fa-laptop"></i> Dashboard</h3>
...
?>
          ...
          <div class=" col-lg-4 col-md-4 col-sm-12 col-xs-12 rounded-4">
